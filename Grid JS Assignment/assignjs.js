    ...
    let div=document.createElement("div")
      ...
      for(i=1;i<=5;i++)
      {
        ...
        let full_image=document.createElement("img")
         full_image.id="img";
         full_image.src=productList[i-1]["preview"]
         sub_div.appendChild(full_image)

          let title=document.createElement("p")
           title.id="title";
           title.innerText=productList[i-1]["name"]
           sub_div.appendChild(title)

           let brand=document.createElement("p")
           brand.id="brand";
           brand.innerText=productList[i-1]["brand"]
           sub_div.appendChild(brand)

           let price1=document.createElement("p")
           price1.id="price";
           price1.innerText="RS "+productList[i-1]["price"]
           sub_div.appendChild(price1)
      ...
      heading1.id="heading";
      heading1.innerHTML="Accessories for Men and Women";
       ...
       for(i=6;i<=10;i++)
       {
         ...
         sub_div1.id="bor";
         console.log(sub_div1)
         div1.appendChild(sub_div1)


         let full_image1=document.createElement("img")
         full_image1.id="img";
         full_image1.src=productList[i-1]["preview"]
         sub_div1.appendChild(full_image1)

          let title1=document.createElement("p")
           title1.id="title";
           title1.innerText=productList[i-1]["name"]
           sub_div1.appendChild(title1)

           let brand1=document.createElement("p")
           brand1.id="brand";
           brand1.innerText=productList[i-1]["brand"]
           sub_div1.appendChild(brand1)

           let price=document.createElement("p")
           price.id="price";
           price.innerText="RS "+productList[i-1]["price"]
           sub_div1.appendChild(price)
